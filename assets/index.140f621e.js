 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tn=new mo("@firebase/app"),U_="@firebase/app-compat",$_="@firebase/analytics-compat",H_="@firebase/analytics",W_="@firebase/app-check-compat",V_="@firebase/app-check",j_="@firebase/auth",q_="@firebase/auth-compat",z_="@firebase/database",K_="@firebase/database-compat",G_="@firebase/functions",Y_="@firebase/functions-compat",Q_="@firebase/installations",J_="@firebase/installations-compat",X_="@firebase/messaging",Z_="@firebase/messaging-compat",eg="@firebase/performance",tg="@firebase/performance-compat",ng="@firebase/remote-config",sg="@firebase/remote-config-compat",ig="@firebase/storage",rg="@firebase/storage-compat",og="@firebase/firestore",lg="@firebase/firestore-compat",ag="firebase",cg="10.7.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nr="[DEFAULT]",ug={[xr]:"fire-core",[U_]:"fire-core-compat",[H_]:"fire-analytics",[$_]:"fire-analytics-compat",[V_]:"fire-app-check",[W_]:"fire-app-check-compat",[j_]:"fire-auth",[q_]:"fire-auth-compat",[z_]:"fire-rtdb",[K_]:"fire-rtdb-compat",[G_]:"fire-fn",[Y_]:"fire-fn-compat",[Q_]:"fire-iid",[J_]:"fire-iid-compat",[X_]:"fire-fcm",[Z_]:"fire-fcm-compat",[eg]:"fire-perf",[tg]:"fire-perf-compat",[ng]:"fire-rc",[sg]:"fire-rc-compat",[ig]:"fire-gcs",[rg]:"fire-gcs-compat",[og]:"fire-fst",[lg]:"fire-fst-compat","fire-js":"fire-js",[ag]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function om({appConfig:t,heartbeatServiceProvider:e},n){const s=lm(t,n),i=Wg(t,n),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={installation:{sdkVersion:vu,appId:t.appId}},l={method:"POST",headers:i,body:JSON.stringify(o)},a=await Su(()=>fetch(s,l));if(a.ok){const c=await a.json();return wu(c)}else throw await Iu("Generate Auth Token",a)}function lm(t,{fid:e}){return`${Eu(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lm=30,Fm=1e3;class Bm{constructor(e={},n=Fm){this.throttleMetadata=e,this.intervalMillis=n}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,n){this.throttleMetadata[e]=n}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const Lu=new Bm;function Um(t){return new Headers({Accept:"application/json","x-goog-api-key":t})}async function $m(t){var e;const{appId:n,apiKey:s}=t,i={method:"GET",headers:Um(s)},r=Tm.replace("{app-id}",n),o=await fetch(r,i);if(o.status!==200&&o.status!==304){let l="";try{const a=await o.json();!((e=a.error)===null||e===void 0)&&e.message&&(l=a.error.message)}catch{}throw Be.create("config-fetch-failed",{httpStatus:o.status,responseMessage:l})}return o.json()}async function Hm(t,e=Lu,n){const{appId:s,apiKey:i,measurementId:r}=t.options;if(!s)throw Be.create("no-app-id");if(!i){if(r)return{measurementId:r,appId:s};throw Be.create("no-api-key")}const o=e.getThrottleMetadata(s)||{backoffCount:0,throttleEndTimeMillis:Date.now()},l=new jm;return setTimeout(async()=>{l.abort()},n!==void 0?n:Im),Fu({appId:s,apiKey:i,measurementId:r},o,l,e)}async function Fu(t,{throttleEndTimeMillis:e,backoffCount:n},s,i=Lu){var r;const{appId:o,measurementId:l}=t;try{await Wm(s,e)}catch(a){if(l)return Pe.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${a==null?void 0:a.message}]`),{appId:o,measurementId:l};throw a}try{const a=await $m(t);return i.deleteThrottleMetadata(o),a}catch(a){const c=a;if(!Vm(c)){if(i.deleteThrottleMetadata(o),l)return Pe.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${l} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:l};throw a}const u=Number((r=c==null?void 0:c.customData)===null||r===void 0?void 0:r.httpStatus)===503?Ql(n,i.intervalMillis,Lm):Ql(n,i.intervalMillis),h={throttleEndTimeMillis:Date.now()+u,backoffCount:n+1};return i.setThrottleMetadata(o,h),Pe.debug(`Calling attemptFetch again in ${u} millis`),Fu(t,h,s,i)}}function Wm(t,e){return new Promise((n,s)=>{const i=Math.max(e-Date.now(),0),r=setTimeout(n,i);t.addEventListener(()=>{clearTimeout(r),s(Be.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function Vm(t){if(!(t instanceof un)||!t.customData)return!1;const e=Number(t.customData.httpStatus);return e===429||e===500||e===503||e===504}class jm{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function qm(t,e,n,s,i){if(i&&i.global){t("event",n,s);return}else{const r=await e,o=Object.assign(Object.assign({},s),{send_to:r});t("event",n,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e){this.writeTree_=e}static empty(){return new Qe(new ee(null))}}function Qn(t,e,n){if($(e))return new Qe(new ee(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=Re(i,e);return r=r.updateChild(o,n),new Qe(t.writeTree_.set(i,r))}else{const i=new ee(n),r=t.writeTree_.setTree(e,i);return new Qe(r)}}}function Oa(t,e,n){let s=t;return Oe(n,(i,r)=>{s=Qn(s,he(e,i),r)}),s}function Ma(t,e){if($(e))return Qe.empty();{const n=t.writeTree_.setTree(e,new ee(null));return new Qe(n)}}function $r(t,e){return hn(t,e)!=null}function hn(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Re(n.path,e)):null}function La(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(ae,(s,i)=>{e.push(new U(s,i))}):t.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new U(s,i.value))}),e}function At(t,e){if($(e))return t;{const n=hn(t,e);return n!=null?new Qe(new ee(n)):new Qe(t.writeTree_.subtree(e))}}function Hr(t){return t.writeTree_.isEmpty()}function Nn(t,e){return Eh(j(),t.writeTree_,e)}function Eh(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(b(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):n=Eh(he(t,i),r,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(he(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TC=/[\[\].#$\/\u0000-\u001F\u007F]/,SC=/[\[\].#$\u0000-\u001F\u007F]/,lr=10*1024*1024,Hh=function(t){return typeof t=="string"&&t.length!==0&&!TC.test(t)},Wh=function(t){return typeof t=="string"&&t.length!==0&&!SC.test(t)},AC=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Wh(t)},Vh=function(t,e,n,s){s&&e===void 0||Qo(go(t,"value"),e,n)},Qo=function(t,e,n){const s=n instanceof G?new qy(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Wt(s));if(typeof e=="function")throw new Error(t+"contains a function "+Wt(s)+" with contents = "+e.toString());if(Wu(e))throw new Error(t+"contains "+e.toString()+" "+Wt(s));if(typeof e=="string"&&e.length>lr/3&&Ei(e)>lr)throw new Error(t+"contains a string greater than "+lr+" utf8 bytes "+Wt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(Oe(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Hh(o)))throw new Error(t+" contains an invalid key ("+o+") "+Wt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);zy(s,o),Qo(t,l,s),Ky(s)}),i&&r)throw new Error(t+' contains ".value" child '+Wt(s)+" in addition to actual children.")}},jh=function(t,e,n,s){if(!(s&&n===void 0)&&!Wh(n))throw new Error(go(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},xC=function(t,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),jh(t,e,n,s)},Jo=function(t,e){if(B(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},NC=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Hh(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!AC(n))throw new Error(go(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
